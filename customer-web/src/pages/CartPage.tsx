  ...
  return (
    <div className="stack-lg">
      <section className="surface stack-lg">
        <SectionHeading
          description="Review quantities, confirm the shipping address, and place the order from one checkout workspace."
          eyebrow="Cart"
          title="Review the cart and confirm delivery details"
        />
          ...
          <div className="cart-layout">
            ...
            <aside className="detail-panel cart-summary cart-summary-sticky">
              ...
              <div className="summary-section">
                ...
                <p className="supporting-copy">
                  Orders are created using the selected shipping address shown above.
                </p>
              </div>
            </aside>
          </div>

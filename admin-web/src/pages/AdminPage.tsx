...
export function AdminPage() {
  ...
  function renderProductSection() {
    return (
      <div className="surface stack-lg" id="catalog-intake">
        <SectionHeading
          description="Create sellable products with the merchandising and operational fields the team needs every day."
  ...
  return (
    <div className="admin-console-shell">
        ...
        <div className="hero-grid admin-hero-grid">
          <div className="stack-lg">
            <div className="hero-copy-block admin-hero-copy">
              ...
              <h1 className="hero-title">Manage daily order flow, service queues, and catalog intake.</h1>
              <p className="hero-copy">
                This workspace is tuned for real operational use: quick health checks at the top,
                searchable order handling in the center, and refund, support, and catalog tasks
                split into clearer work areas.
              </p>
            </div>
      ...
      {dashboardSummary ? (
        <section className="surface admin-overview-strip" id="overview">
          <SectionHeading
          ...
          <div className="metric-grid dashboard-summary-grid">
            <article className="stat-card stat-card-strong">
              ...
              <span className="supporting-copy">All recorded orders in the current workspace</span>
            </article>
          ...
          <div className="dashboard-board-grid">
            ...
            <article className="surface stack dashboard-panel">
              <div className="dashboard-panel-header">
                <div>
                  <p className="eyebrow">Commercial view</p>
                  <h3 className="card-title">Revenue and order value</h3>
                </div>
                <span className="signal">30-day window</span>
              </div>

              <div className="dashboard-stack-grid">
                <div className="info-card">
                  <p className="eyebrow">Captured revenue</p>
                  <strong>{formatCurrency(dashboardSummary.capturedRevenue30Days)}</strong>
                  <span className="supporting-copy">Paid orders recognized across the last 30 days.</span>
                </div>
                <div className="info-card">
                  <p className="eyebrow">Average order value</p>
                  <strong>{formatCurrency(dashboardSummary.averageOrderValue30Days)}</strong>
                  <span className="supporting-copy">Useful when checking promotion quality and support cost pressure.</span>
                </div>
              </div>
            </article>
          </div>
      ...
      <section className="surface stack-lg" id="workbench">
        ...
        <div className="admin-workbench-shell">
          ...
          <aside className="admin-side-column">{renderProductSection()}</aside>
        </div>
      </section>
    </div>
  )
